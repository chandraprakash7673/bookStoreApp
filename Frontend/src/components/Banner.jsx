    ...
    <>
      <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-12' >
        <div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36'>
          <div className='space-y-12'>
            ...
            <p className='text-xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus
              soluta dolorum consectetur! Accusamus quibusdam repellendus placeat
              ab quaerat libero mollitia ratione architecto, dicta laudantium corporis obcaecati. Facere aspernatur modi minus!
            </p>
            <label className="dark:bg-slate-900 dark:text-white input validator mb-0">
        ...
        <div className='order-1 w-full md:w-1/2'>
          <img className='md:w-[550px] md:h-[460px] md:ml-12 mt-24' src={banner} alt="" />
        </div>
      </div>
    </>
  )
