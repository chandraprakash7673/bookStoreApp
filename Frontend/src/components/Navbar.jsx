                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div className='hidden md:block'>
                            <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                                ...
                                <input className="focus:outline-none focus:ring-0 border-none" type="search" required placeholder="Search" />
                        ...
                        <div className="">
                            <a className="bg-black text-white px-2 py-2 rounded-md hover:bg-slate-300 duration-300 cursor-pointer
